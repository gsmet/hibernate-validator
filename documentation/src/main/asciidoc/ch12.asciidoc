...
This might not be the desired behavior if you usually set your system locale to `en-US` but want your application to provide messages in French.
...
which allows to finely tune the resolution of the locale.
