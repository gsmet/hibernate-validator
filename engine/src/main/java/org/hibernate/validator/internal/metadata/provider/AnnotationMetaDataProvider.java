...
public class AnnotationMetaDataProvider implements MetaDataProvider {
	...
	private <A extends Annotation> MetaConstraint<?> createMetaConstraint(ConstraintDescriptorImpl<A> descriptor, ConstraintLocation location) {
		return new MetaConstraint<>( descriptor, location );
	}
